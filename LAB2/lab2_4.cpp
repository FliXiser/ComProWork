...
int main(){
    ...
    cout << "Maximum value of usigned char :" << UCHAR_MAX << endl;
    cout << "Maximum value of usigned short :" << USHRT_MAX << endl;
    cout << "Maximum value of usigned int :" << UINT_MAX << endl;
    cout << "Maximum value of usigned long :" << ULONG_MAX << endl;
    return 0;
}
